...
we() {
  ...
  cargo watch --quiet --clear --watch /workspace/crates/api/examples/$1.rs --watch /workspace/crates/api/src/ --watch /workspace/.cargo/ --watch /workspace/crates/api/src --watch /workspace/crates/log/src --watch /workspace/sql --delay 5 --exec "run --example $1"
}
